...
class UIView ui {
    ...
    bool hidden, raycastTarget, eventsEnabled, clipsSubviews, ignoresClipping;
    ...
    virtual void onMouseDown(Vector2 screenPos) { }
    virtual void onMouseUp(Vector2 screenPos) { }
    ...
    void clip(int left, int top, int width, int height, int flags = 0) {
        if(flags != 0) {
